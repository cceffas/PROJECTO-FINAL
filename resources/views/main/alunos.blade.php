...
<div class="mt-20 space-y-10">
    ...
    <x-bladewind::card>
        <div class="flex justify-between items-center">
            ...
            <x-bladewind::button onclick="showModal('aluno')">criar novo</x-bladewind::button>
        </div>
    </x-bladewind::card>
    {{-- end title section --}}
    <x-bladewind::card>
        <x-bladewind::table has_border=true searchable=true>
            ...
            @endisset
            {{-- end --}}
            <x-bladewind::modal name="aluno" show_action_buttons=false size='large'>
                <x-bladewind::card>
                    <div>
                        <form action="/alunos/criar" method="post" enctype="multipart/form-data">
                            ...
                            <div class="flex gap-2">
                                <x-bladewind::input label='telefone' numeric=true name='tel' />
                                <x-bladewind::input label='numero de BI' numeric=true name='bi' required />
                            </div>
                            {{-- end --}}
                            ...
                            @if($cursos)
                            <div class="flex justify-end gap-4 mt-2">
                                <x-bladewind::button type='secondary' onclick="hideModal('aluno')">cancelar</x-bladewind::button>
                                <x-bladewind::button can_submit=true>confirmar</x-bladewind::button>
                            </div>
                            @else
