...
@section('content')
    @php
        $class_input = 'appearance-none bg-transparent w-full border-none outline outline-1 outline-slate-300 focus:outline-blue-500 text-slate-500 placeholder-slate-400/50';
    @endphp

    <div class="mt-20 space-y-10">
        <x-Title-app title='pagamentos > registrar' icon='bi-credit-card' action='/pagamentos' text_action='voltar' type='secondary' />
            ...
            <form action="/pagamentos/criar" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4">
                ...
                <div>
                    ...
                    <div class="flex items-center border border-slate-300 rounded">
                        ...
                        <input type="number" step="0.01" name="valor" id="valor" required min="0"
                ...
                <!-- Método de Pagamento -->
                <div>
                    <label for="m_pagamento" class="block text-sm font-medium text-slate-600 mb-1">Método de Pagamento</label>
                    <div class="flex items-center border border-slate-300 rounded">
                ...
                <!-- Comprovativo -->
                <div>
                    <label for="comprovativo" class="block text-sm font-medium text-slate-600 mb-1">Comprovativo (PDF ou imagem)</label>
                    <x-bladewind::filepicker name="comprovativo" accepted_file_types="application/pdf,image/*" max_file_size="5mb" placeholder="Selecione o comprovativo" required />
                </div>
