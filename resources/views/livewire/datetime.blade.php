...
<div class="flex flex-col justify-center w-full mb-4">
    ...
    <div class="flex items-center relative">
        <input class='appearance-none w-full text-slate-400 outline-[1px] outline outline-slate-300 h-10 text-sm border-none overflow-hidden rounded-md' type="date" name="{{ $name }}" required  id="{{$name}}" value="{{$date}}" />
        {{-- end --}}
